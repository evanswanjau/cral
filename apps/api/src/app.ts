...
import { adminServiceRequestsRouter } from "./modules/admin-service-requests/routes.js";
...
import { customerBookingsRouter } from "./modules/customer-bookings/routes.js";
import { serviceRequestsRouter } from "./modules/service-requests/routes.js";
...
export function createApp(): Express {
  ...
  app.use(adminServiceRequestsRouter);
  app.use(merchantRouter);
  app.use(vehiclesRouter);
  app.use(catalogRouter);
  app.use(customerAccountRouter);
  app.use(customerBookingsRouter);
