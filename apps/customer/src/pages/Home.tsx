...
const CARD_TINTS = ["#EEF0F3", "#EDEFF4", "#F0EFEC", "#EBEDF0", "#EFEEF1", "#ECEEF2"];
    ...
    >
      ...
      >
        ...
        {car.verified && (
          ...
          >
            <span
              style={{ width: 6, height: 6, borderRadius: 999, background: "#0B8A5B" }}
            />
            Verified
          </span>
        )}
      ...
      <div style={{ padding: "14px 15px 15px" }}>
        ...
        >
          ...
          >
            ...
            <span
              style={{ font: "400 11.5px/1 'Instrument Sans',sans-serif", color: "#838C9B" }}
            >
              {" "}
              / day
            </span>
