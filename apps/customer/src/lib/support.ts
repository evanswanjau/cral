/**
 * CRAL's support line - the same number the merchant portal uses
 * (`apps/merchant/src/lib/support.ts`). Build WhatsApp links with
 * `whatsappLink()` rather than hand-writing `wa.me` URLs.
 */
